...
class Yolov7Publisher:
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        np_img_orig  =self.bridge.imgmsg_to_cv2(img_msg ,desired_encoding='bgr8')
        ...
        if self.visualization_publisher:
            ...
            cv2.imshow('yolov7_result_traffic', resize_vis_img)
    ...
    def publish_image(self, imagedata, height, width):
        ...
        image_temp.data = np.array(imagedata).tobytes()
